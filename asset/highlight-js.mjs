...
const y = "[a-zA-Z]\\w*", _ = "[a-zA-Z_]\\w*", w = "\\b\\d+(\\.\\d+)?", x = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", A = "\\b(0b[01]+)", N = { begin: "\\\\[\\s\\S]", relevance: 0 }, S = { scope: "string", begin: "'", end: "'", illegal: "\\n", contains: [N] }, v = { scope: "string", begin: '"', end: '"', illegal: "\\n", contains: [N] }, O = function(e2, n2, t2 = {}) {
  ...
  const s2 = b("I", "a", "is", "so", "us", "to", "at", "if", "in", "it", "on", /[A-Za-z]+['](d|ve|re|ll|t|s|n)/, /[A-Za-z]+[-][a-z]+/, /[A-Za-z][a-z]{2,}/);
...
var $ = Object.freeze({ __proto__: null, APOS_STRING_MODE: S, BACKSLASH_ESCAPE: N, BINARY_NUMBER_MODE: j, BINARY_NUMBER_RE: A, COMMENT: O, C_BLOCK_COMMENT_MODE: R, C_LINE_COMMENT_MODE: k, C_NUMBER_MODE: T, C_NUMBER_RE: x, END_SAME_AS_BEGIN: function(e2) {
  ...
  const n2 = /^#![ ]*\//;
  return e2.binary && (e2.begin = f(n2, /.*\b/, e2.binary, /\b.*/)), r({ scope: "meta", begin: n2, end: /$/, relevance: 0, "on:begin": (e3, n3) => {
...
function ne(e2, n2, { key: t2 }) {
  let i2 = 0;
  const r2 = e2[t2], s2 = {}, a2 = {};
  for (let e3 = 1; e3 <= n2.length; e3++)
    a2[e3 + i2] = r2[e3], s2[e3 + i2] = true, i2 += p(n2[e3 - 1]);
  e2[t2] = a2, e2[t2]._emit = s2, e2[t2]._multi = true;
}
function te(e2) {
  !function(e3) {
...
function ie(e2) {
  ...
  return e2.classNameAliases = r(e2.classNameAliases || {}), function t3(s2, a2) {
    const o2 = s2;
    if (s2.isCompiled)
      return o2;
    [H, Z, te, G].forEach((e3) => e3(s2, a2)), e2.compilerExtensions.forEach((e3) => e3(s2, a2)), s2.__beforeBegin = null, [U, z, F].forEach((e3) => e3(s2, a2)), s2.isCompiled = true;
    let c2 = null;
    return "object" == typeof s2.keywords && s2.keywords.$pattern && (s2.keywords = Object.assign({}, s2.keywords), c2 = s2.keywords.$pattern, delete s2.keywords.$pattern), c2 = c2 || /\w+/, s2.keywords && (s2.keywords = X(s2.keywords, e2.case_insensitive)), o2.keywordPatternRe = n2(c2, true), a2 && (s2.begin || (s2.begin = /\B|\b/), o2.beginRe = n2(o2.begin), s2.end || s2.endsWithParent || (s2.end = /\B|\b/), s2.end && (o2.endRe = n2(o2.end)), o2.terminatorEnd = g(o2.end) || "", s2.endsWithParent && a2.terminatorEnd && (o2.terminatorEnd += (s2.end ? "|" : "") + a2.terminatorEnd)), s2.illegal && (o2.illegalRe = n2(s2.illegal)), s2.contains || (s2.contains = []), s2.contains = [].concat(...s2.contains.map(function(e3) {
      return function(e4) {
      ...
      t3(e3, o2);
    }), s2.starts && t3(s2.starts, a2), o2.matcher = function(e3) {
      const n3 = new i2();
...
const ae = i, oe = r, ce = Symbol("nomatch"), le = function(e2) {
  ...
  function m2(e3, n2, t2) {
    let i3 = "", r3 = "";
    "object" == typeof n2 ? (i3 = e3, t2 = n2.ignoreIllegals, r3 = n2.language) : (Y("10.7.0", "highlight(lang, code, ...args) has been deprecated."), Y("10.7.0", "Please use highlight(code, options) instead.\nhttps://github.com/highlightjs/highlight.js/issues/2277"), r3 = e3, i3 = n2), void 0 === t2 && (t2 = true);
    const s3 = { code: i3, language: r3 };
    v2("before:highlight", s3);
    const a3 = s3.result ? s3.result : E2(s3.language, s3.code, t2);
    return a3.code = s3.code, v2("after:highlight", a3), a3;
  }
  function E2(e3, n2, r3, s3) {
    ...
    function l2() {
      ...
      for (; n3; ) {
        ...
        const r4 = x3.case_insensitive ? n3[0].toLowerCase() : n3[0], s4 = (i3 = r4, v3.keywords[i3]);
        if (s4) {
          const [e5, i4] = s4;
          if (k2.addText(t2), t2 = "", c3[r4] = (c3[r4] || 0) + 1, c3[r4] <= 7 && (M2 += i4), e5.startsWith("_"))
            t2 += n3[0];
          else {
    ...
    function h2(e4, n3) {
      ...
      for (; t2 <= i3; ) {
        ...
        const i4 = x3.classNameAliases[e4[t2]] || e4[t2], r4 = n3[t2];
        i4 ? d2(r4, i4) : (R2 = r4, l2(), R2 = ""), t2++;
      }
    }
    function f2(e4, n3) {
    ...
    function m3(e4) {
      const t2 = e4[0], i3 = n2.substring(e4.index), r4 = b2(v3, e4, i3);
      if (!r4)
        return ce;
      const s4 = v3;
      v3.endScope && v3.endScope._wrap ? (u2(), d2(t2, v3.endScope._wrap)) : v3.endScope && v3.endScope._multi ? (u2(), h2(v3.endScope, e4)) : s4.skip ? R2 += t2 : (s4.returnEnd || s4.excludeEnd || (R2 += t2), u2(), s4.excludeEnd && (R2 = t2));
      do {
        v3.scope && k2.closeNode(), v3.skip || v3.subLanguage || (M2 += v3.relevance), v3 = v3.parent;
      } while (v3 !== r4.parent);
      return r4.starts && f2(r4.starts, e4), s4.returnEnd ? 0 : t2.length;
    }
    let _3 = {};
    function w3(i3, s4) {
      const o3 = s4 && s4[0];
      if (R2 += i3, null == o3)
        return u2(), 0;
      if ("begin" === _3.type && "end" === s4.type && _3.index === s4.index && "" === o3) {
        if (R2 += n2.slice(s4.index, s4.index + 1), !a2) {
          const n3 = new Error(`0 width match regex (${e3})`);
          throw n3.languageName = e3, n3.badRule = _3.rule, n3;
        }
        return 1;
      }
      if (_3 = s4, "begin" === s4.type)
        return function(e4) {
    ...
    try {
      ...
      if (t2.message && t2.message.includes("Illegal"))
        return { language: e3, value: ae(n2), illegal: true, relevance: 0, _illegalBy: { message: t2.message, index: I2, context: n2.slice(I2 - 100, I2 + 100), mode: t2.mode, resultSoFar: S3 }, _emitter: k2 };
      if (a2)
        return { language: e3, value: ae(n2), illegal: false, relevance: 0, errorRaised: t2, _emitter: k2, _top: v3 };
      throw t2;
    }
  }
  function y2(e3, n2) {
    ...
    const t2 = function(e4) {
      const n3 = { value: ae(e4), illegal: false, relevance: 0, _top: c2, _emitter: new g2.__emitter(g2) };
      return n3._emitter.addText(e4), n3;
    }(e3), r3 = n2.filter(A2).filter(S2).map((n3) => E2(n3, e3, false));
    r3.unshift(t2);
  ...
  function _2(e3) {
    ...
    }(e3, t2, s3.language), e3.result = { language: s3.language, re: s3.relevance, relevance: s3.relevance }, s3.secondBest && (e3.secondBest = { language: s3.secondBest.language, relevance: s3.secondBest.relevance }), v2("after:highlightElement", { el: e3, result: s3, text: i3 });
  }
  let w2 = false;
  function x2() {
  ...
  "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", function() {
    ...
    try {
      ...
      if (V("Language definition for '{}' could not be registered.".replace("{}", n2)), !a2)
        throw e3;
      V(e3), r3 = c2;
    }
    r3.name || (r3.name = n2), i2[n2] = r3, r3.rawDefinition = t2.bind(null, e2), r3.aliases && N2(r3.aliases, { languageName: n2 });
...
function we(e2 = document) {
  console.log("SDFSDFSDF", e2.querySelectorAll('code[lang="javascript"]')), e2.querySelectorAll('code[lang="javascript"]').forEach((e3) => {
    de.highlightElement(e3);
  });
}
de.registerLanguage("javascript", (e2) => function(e3) {
  const n2 = e3.regex, t2 = he, i2 = "<>", r2 = "</>", s2 = { begin: /<[A-Za-z0-9\\._:-]+/, end: /\/[A-Za-z0-9\\._:-]+>|\/>/, isTrulyOpeningTag: (e4, n3) => {
    ...
    const s3 = e4.input.substring(t3);
    ((r3 = s3.match(/^\s*=/)) || (r3 = s3.match(/^\s+extends\s+/)) && 0 === r3.index) && n3.ignoreMatch();
  } }, a2 = { $pattern: he, keyword: fe, literal: be, built_in: _e, "variable.language": ye }, o2 = "[0-9](_?[0-9])*", c2 = `\\.(${o2})`, l2 = "0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*", g2 = { className: "number", variants: [{ begin: `(\\b(${l2})((${c2})|\\.)?|(${c2}))[eE][+-]?(${o2})\\b` }, { begin: `\\b(${l2})\\b((${c2})\\b|\\.)?|(${c2})\\b` }, { begin: "\\b(0|[1-9](_?[0-9])*)n\\b" }, { begin: "\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b" }, { begin: "\\b0[bB][0-1](_?[0-1])*n?\\b" }, { begin: "\\b0[oO][0-7](_?[0-7])*n?\\b" }, { begin: "\\b0[0-7]+n?\\b" }], relevance: 0 }, u2 = { className: "subst", begin: "\\$\\{", end: "\\}", keywords: a2, contains: [] }, d2 = { begin: "html`", end: "", starts: { end: "`", returnEnd: false, contains: [e3.BACKSLASH_ESCAPE, u2], subLanguage: "xml" } }, h2 = { begin: "css`", end: "", starts: { end: "`", returnEnd: false, contains: [e3.BACKSLASH_ESCAPE, u2], subLanguage: "css" } }, f2 = { begin: "gql`", end: "", starts: { end: "`", returnEnd: false, contains: [e3.BACKSLASH_ESCAPE, u2], subLanguage: "graphql" } }, b2 = { className: "string", begin: "`", end: "`", contains: [e3.BACKSLASH_ESCAPE, u2] }, p2 = { className: "comment", variants: [e3.COMMENT(/\/\*\*(?!\/)/, "\\*/", { relevance: 0, contains: [{ begin: "(?=@[A-Za-z]+)", relevance: 0, contains: [{ className: "doctag", begin: "@[A-Za-z]+" }, { className: "type", begin: "\\{", end: "\\}", excludeEnd: true, excludeBegin: true, relevance: 0 }, { className: "variable", begin: t2 + "(?=\\s*(-)|$)", endsParent: true, relevance: 0 }, { begin: /(?=[^\n])\s/, relevance: 0 }] }] }), e3.C_BLOCK_COMMENT_MODE, e3.C_LINE_COMMENT_MODE] }, m2 = [e3.APOS_STRING_MODE, e3.QUOTE_STRING_MODE, d2, h2, f2, b2, { match: /\$\d+/ }, g2];
  u2.contains = m2.concat({ begin: /\{/, end: /\}/, keywords: a2, contains: ["self"].concat(m2) });
  const E2 = [].concat(p2, u2.contains), y2 = E2.concat([{ begin: /\(/, end: /\)/, keywords: a2, contains: ["self"].concat(E2) }]), _2 = { className: "params", begin: /\(/, end: /\)/, excludeBegin: true, excludeEnd: true, keywords: a2, contains: y2 }, w2 = { variants: [{ match: [/class/, /\s+/, t2, /\s+/, /extends/, /\s+/, n2.concat(t2, "(", n2.concat(/\./, t2), ")*")], scope: { 1: "keyword", 3: "title.class", 5: "keyword", 7: "title.class.inherited" } }, { match: [/class/, /\s+/, t2], scope: { 1: "keyword", 3: "title.class" } }] }, x2 = { relevance: 0, match: n2.either(/\bJSON/, /\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/, /\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/, /\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/), className: "title.class", keywords: { _: [...pe, ...me] } }, A2 = { variants: [{ match: [/function/, /\s+/, t2, /(?=\s*\()/] }, { match: [/function/, /\s*(?=\()/] }], className: { 1: "keyword", 3: "title.function" }, label: "func.def", contains: [_2], illegal: /%/ }, N2 = { match: n2.concat(/\b/, (S2 = [...Ee, "super", "import"], n2.concat("(?!", S2.join("|"), ")")), t2, n2.lookahead(/\(/)), className: "title.function", relevance: 0 };
  var S2;
  ...
  return { name: "JavaScript", aliases: ["js", "jsx", "mjs", "cjs"], keywords: a2, exports: { PARAMS_CONTAINS: y2, CLASS_REFERENCE: x2 }, illegal: /#(?![$_A-z])/, contains: [e3.SHEBANG({ label: "shebang", binary: "node", relevance: 5 }), { label: "use_strict", className: "meta", relevance: 10, begin: /^\s*['"]use (strict|asm)['"]/ }, e3.APOS_STRING_MODE, e3.QUOTE_STRING_MODE, d2, h2, f2, b2, p2, { match: /\$\d+/ }, g2, x2, { className: "attr", begin: t2 + n2.lookahead(":"), relevance: 0 }, R2, { begin: "(" + e3.RE_STARTERS_RE + "|\\b(case|return|throw)\\b)\\s*", keywords: "return throw case", relevance: 0, contains: [p2, e3.REGEXP_MODE, { className: "function", begin: k2, returnBegin: true, end: "\\s*=>", contains: [{ className: "params", variants: [{ begin: e3.UNDERSCORE_IDENT_RE, relevance: 0 }, { className: null, begin: /\(\s*\)/, skip: true }, { begin: /\(/, end: /\)/, excludeBegin: true, excludeEnd: true, keywords: a2, contains: y2 }] }] }, { begin: /,/, relevance: 0 }, { match: /\s+/, relevance: 0 }, { variants: [{ begin: i2, end: r2 }, { match: /<[A-Za-z0-9\\._:-]+\s*\/>/ }, { begin: s2.begin, "on:begin": s2.isTrulyOpeningTag, end: s2.end }], subLanguage: "xml", contains: [{ begin: s2.begin, end: s2.end, skip: true, contains: ["self"] }] }] }, A2, { beginKeywords: "while if switch catch for" }, { begin: "\\b(?!function)" + e3.UNDERSCORE_IDENT_RE + "\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{", returnBegin: true, label: "func.def", contains: [_2, e3.inherit(e3.TITLE_MODE, { begin: t2, className: "title.function" })] }, { match: /\.\.\./, relevance: 0 }, v2, { match: "\\$" + t2, relevance: 0 }, { match: [/\bconstructor(?=\s*\()/], className: { 1: "title.function" }, contains: [_2] }, N2, { relevance: 0, match: /\b[A-Z][A-Z_0-9]+\b/, className: "variable.constant" }, w2, O2, { match: /\$[(.]/ }] };
