...
const y = "[a-zA-Z]\\w*", _ = "[a-zA-Z_]\\w*", w = "\\b\\d+(\\.\\d+)?", x = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", A = "\\b(0b[01]+)", N = { begin: "\\\\[\\s\\S]", relevance: 0 }, v = { scope: "string", begin: "'", end: "'", illegal: "\\n", contains: [N] }, S = { scope: "string", begin: '"', end: '"', illegal: "\\n", contains: [N] }, O = function(e2, n2, t2 = {}) {
  ...
  const r2 = b("I", "a", "is", "so", "us", "to", "at", "if", "in", "it", "on", /[A-Za-z]+['](d|ve|re|ll|t|s|n)/, /[A-Za-z]+[-][a-z]+/, /[A-Za-z][a-z]{2,}/);
...
function ne(e2, n2, { key: t2 }) {
  ...
  for (let e3 = 1; e3 <= n2.length; e3++)
    a2[e3 + i2] = s2[e3], r2[e3 + i2] = true, i2 += p(n2[e3 - 1]);
  e2[t2] = a2, e2[t2]._emit = r2, e2[t2]._multi = true;
}
function te(e2) {
  !function(e3) {
...
function ie(e2) {
  ...
  return e2.classNameAliases = s(e2.classNameAliases || {}), function t3(r2, a2) {
    const o2 = r2;
    if (r2.isCompiled)
      return o2;
    [H, Z, te, G].forEach((e3) => e3(r2, a2)), e2.compilerExtensions.forEach((e3) => e3(r2, a2)), r2.__beforeBegin = null, [U, z, F].forEach((e3) => e3(r2, a2)), r2.isCompiled = true;
    let c2 = null;
    return "object" == typeof r2.keywords && r2.keywords.$pattern && (r2.keywords = Object.assign({}, r2.keywords), c2 = r2.keywords.$pattern, delete r2.keywords.$pattern), c2 = c2 || /\w+/, r2.keywords && (r2.keywords = X(r2.keywords, e2.case_insensitive)), o2.keywordPatternRe = n2(c2, true), a2 && (r2.begin || (r2.begin = /\B|\b/), o2.beginRe = n2(o2.begin), r2.end || r2.endsWithParent || (r2.end = /\B|\b/), r2.end && (o2.endRe = n2(o2.end)), o2.terminatorEnd = u(o2.end) || "", r2.endsWithParent && a2.terminatorEnd && (o2.terminatorEnd += (r2.end ? "|" : "") + a2.terminatorEnd)), r2.illegal && (o2.illegalRe = n2(r2.illegal)), r2.contains || (r2.contains = []), r2.contains = [].concat(...r2.contains.map(function(e3) {
      return function(e4) {
      ...
      t3(e3, o2);
    }), r2.starts && t3(r2.starts, a2), o2.matcher = function(e3) {
      const n3 = new i2();
...
const ae = i, oe = s, ce = Symbol("nomatch"), le = function(e2) {
  ...
  function m2(e3, n2, t2) {
    ...
    const r3 = { code: i3, language: s3 };
    S2("before:highlight", r3);
    const a3 = r3.result ? r3.result : E2(r3.language, r3.code, t2);
    return a3.code = r3.code, S2("after:highlight", a3), a3;
  }
  function E2(e3, n2, s3, r3) {
    ...
    function l2() {
      ...
      for (; n3; ) {
        ...
        const s4 = x3.case_insensitive ? n3[0].toLowerCase() : n3[0], r4 = (i3 = s4, S3.keywords[i3]);
        if (r4) {
          const [e5, i4] = r4;
    ...
    function m3(e4) {
      ...
      if (!s4)
        return ce;
      const r4 = S3;
      S3.endScope && S3.endScope._wrap ? (g2(), d2(t2, S3.endScope._wrap)) : S3.endScope && S3.endScope._multi ? (g2(), h2(S3.endScope, e4)) : r4.skip ? R2 += t2 : (r4.returnEnd || r4.excludeEnd || (R2 += t2), g2(), r4.excludeEnd && (R2 = t2));
      do {
        S3.scope && k2.closeNode(), S3.skip || S3.subLanguage || (M2 += S3.relevance), S3 = S3.parent;
      } while (S3 !== s4.parent);
      return s4.starts && f2(s4.starts, e4), r4.returnEnd ? 0 : t2.length;
    }
    let _3 = {};
    function w3(i3, r4) {
      const o3 = r4 && r4[0];
      if (R2 += i3, null == o3)
        return g2(), 0;
      if ("begin" === _3.type && "end" === r4.type && _3.index === r4.index && "" === o3) {
        if (R2 += n2.slice(r4.index, r4.index + 1), !a2) {
      ...
      if (_3 = r4, "begin" === r4.type)
        return function(e4) {
          const n3 = e4[0], i4 = e4.rule, s4 = new t(i4), r5 = [i4.__beforeBegin, i4["on:begin"]];
          for (const t2 of r5)
    ...
    try {
      ...
      if (t2.message && t2.message.includes("Illegal"))
        return { language: e3, value: ae(n2), illegal: true, relevance: 0, _illegalBy: { message: t2.message, index: I2, context: n2.slice(I2 - 100, I2 + 100), mode: t2.mode, resultSoFar: v3 }, _emitter: k2 };
      if (a2)
        return { language: e3, value: ae(n2), illegal: false, relevance: 0, errorRaised: t2, _emitter: k2, _top: S3 };
      throw t2;
    }
  }
  function y2(e3, n2) {
    ...
    const t2 = function(e4) {
      const n3 = { value: ae(e4), illegal: false, relevance: 0, _top: c2, _emitter: new u2.__emitter(u2) };
      return n3._emitter.addText(e4), n3;
    }(e3), s3 = n2.filter(A2).filter(v2).map((n3) => E2(n3, e3, false));
    s3.unshift(t2);
    const r3 = s3.sort((e4, n3) => {
  ...
  function _2(e3) {
    ...
    n2 = e3;
    const i3 = n2.textContent, r3 = t2 ? m2(i3, { language: t2, ignoreIllegals: true }) : y2(i3);
    ...
    }(e3, t2, r3.language), e3.result = { language: r3.language, re: r3.relevance, relevance: r3.relevance }, r3.secondBest && (e3.secondBest = { language: r3.secondBest.language, relevance: r3.secondBest.relevance }), S2("after:highlightElement", { el: e3, result: r3, text: i3 });
  }
  let w2 = false;
  function x2() {
...
de.registerLanguage("javascript", (e2) => function(e3) {
  const n2 = e3.regex, t2 = he, i2 = "<>", s2 = "</>", r2 = { begin: /<[A-Za-z0-9\\._:-]+/, end: /\/[A-Za-z0-9\\._:-]+>|\/>/, isTrulyOpeningTag: (e4, n3) => {
  ...
  return { name: "JavaScript", aliases: ["js", "jsx", "mjs", "cjs"], keywords: a2, exports: { PARAMS_CONTAINS: y2, CLASS_REFERENCE: x2 }, illegal: /#(?![$_A-z])/, contains: [e3.SHEBANG({ label: "shebang", binary: "node", relevance: 5 }), { label: "use_strict", className: "meta", relevance: 10, begin: /^\s*['"]use (strict|asm)['"]/ }, e3.APOS_STRING_MODE, e3.QUOTE_STRING_MODE, d2, h2, f2, b2, p2, { match: /\$\d+/ }, u2, x2, { className: "attr", begin: t2 + n2.lookahead(":"), relevance: 0 }, R2, { begin: "(" + e3.RE_STARTERS_RE + "|\\b(case|return|throw)\\b)\\s*", keywords: "return throw case", relevance: 0, contains: [p2, e3.REGEXP_MODE, { className: "function", begin: k2, returnBegin: true, end: "\\s*=>", contains: [{ className: "params", variants: [{ begin: e3.UNDERSCORE_IDENT_RE, relevance: 0 }, { className: null, begin: /\(\s*\)/, skip: true }, { begin: /\(/, end: /\)/, excludeBegin: true, excludeEnd: true, keywords: a2, contains: y2 }] }] }, { begin: /,/, relevance: 0 }, { match: /\s+/, relevance: 0 }, { variants: [{ begin: i2, end: s2 }, { match: /<[A-Za-z0-9\\._:-]+\s*\/>/ }, { begin: r2.begin, "on:begin": r2.isTrulyOpeningTag, end: r2.end }], subLanguage: "xml", contains: [{ begin: r2.begin, end: r2.end, skip: true, contains: ["self"] }] }] }, A2, { beginKeywords: "while if switch catch for" }, { begin: "\\b(?!function)" + e3.UNDERSCORE_IDENT_RE + "\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{", returnBegin: true, label: "func.def", contains: [_2, e3.inherit(e3.TITLE_MODE, { begin: t2, className: "title.function" })] }, { match: /\.\.\./, relevance: 0 }, S2, { match: "\\$" + t2, relevance: 0 }, { match: [/\bconstructor(?=\s*\()/], className: { 1: "title.function" }, contains: [_2] }, N2, { relevance: 0, match: /\b[A-Z][A-Z_0-9]+\b/, className: "variable.constant" }, w2, O2, { match: /\$[(.]/ }] };
