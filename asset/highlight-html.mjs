...
const w = "[a-zA-Z]\\w*", x = "[a-zA-Z_]\\w*", _ = "\\b\\d+(\\.\\d+)?", y = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", N = "\\b(0b[01]+)", v = { begin: "\\\\[\\s\\S]", relevance: 0 }, O = { scope: "string", begin: "'", end: "'", illegal: "\\n", contains: [v] }, S = { scope: "string", begin: '"', end: '"', illegal: "\\n", contains: [v] }, k = function(e2, n2, t2 = {}) {
...
}, M = k("//", "$"), R = k("/\\*", "\\*/"), A = k("#", "$"), j = { scope: "number", begin: _, relevance: 0 }, T = { scope: "number", begin: y, relevance: 0 }, I = { scope: "number", begin: N, relevance: 0 }, L = { scope: "regexp", begin: /\/(?=[^/\n]*\/)/, end: /\/[gimuy]*/, contains: [v, { begin: /\[/, end: /\]/, relevance: 0, contains: [v] }] }, B = { scope: "title", begin: w, relevance: 0 }, P = { scope: "title", begin: x, relevance: 0 }, D = { begin: "\\.\\s*" + x, relevance: 0 };
...
}, TITLE_MODE: B, UNDERSCORE_IDENT_RE: x, UNDERSCORE_TITLE_MODE: P });
function C(e2, n2) {
...
const re = i, ae = s, ce = Symbol("nomatch"), le = function(e2) {
  ...
  function E2(e3, n2, s3, o3) {
    ...
    function u2() {
      null != S3.subLanguage ? function() {
        ...
        if ("string" == typeof S3.subLanguage) {
          ...
          e4 = w2(R2, S3.subLanguage.length ? S3.subLanguage : null);
    ...
    function _3(i3, o4) {
      ...
      if (R2 += i3, null == a3)
        return u2(), 0;
      if ("begin" === x3.type && "end" === o4.type && x3.index === o4.index && "" === a3) {
  ...
  function x2(e3) {
    ...
    n2 = e3;
    const i3 = n2.textContent, o3 = t2 ? m2(i3, { language: t2, ignoreIllegals: true }) : w2(i3);
  ...
  function y2() {
    if ("loading" === document.readyState)
      return void (_2 = true);
    document.querySelectorAll(g2.cssSelector).forEach(x2);
  }
  function N2(e3) {
  ...
  "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", function() {
    _2 && y2();
  }, false), Object.assign(e2, { highlight: m2, highlightAuto: w2, highlightAll: y2, highlightElement: x2, highlightBlock: function(e3) {
...
function he(e2 = document) {
  e2.querySelectorAll('code[lang="html"]').forEach((e3) => {
    de.highlightElement(e3);
  });
}
de.registerLanguage("html", (e2) => function(e3) {
