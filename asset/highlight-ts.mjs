...
const y = "[a-zA-Z]\\w*", w = "[a-zA-Z_]\\w*", _ = "\\b\\d+(\\.\\d+)?", x = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", A = "\\b(0b[01]+)", N = { begin: "\\\\[\\s\\S]", relevance: 0 }, S = { scope: "string", begin: "'", end: "'", illegal: "\\n", contains: [N] }, v = { scope: "string", begin: '"', end: '"', illegal: "\\n", contains: [N] }, O = function(e2, n2, t2 = {}) {
...
}, k = O("//", "$"), R = O("/\\*", "\\*/"), M = O("#", "$"), I = { scope: "number", begin: _, relevance: 0 }, T = { scope: "number", begin: x, relevance: 0 }, j = { scope: "number", begin: A, relevance: 0 }, B = { scope: "regexp", begin: /\/(?=[^/\n]*\/)/, end: /\/[gimuy]*/, contains: [N, { begin: /\[/, end: /\]/, relevance: 0, contains: [N] }] }, L = { scope: "title", begin: y, relevance: 0 }, C = { scope: "title", begin: w, relevance: 0 }, $ = { begin: "\\.\\s*" + w, relevance: 0 };
var D = Object.freeze({ __proto__: null, APOS_STRING_MODE: S, BACKSLASH_ESCAPE: N, BINARY_NUMBER_MODE: j, BINARY_NUMBER_RE: A, COMMENT: O, C_BLOCK_COMMENT_MODE: R, C_LINE_COMMENT_MODE: k, C_NUMBER_MODE: T, C_NUMBER_RE: x, END_SAME_AS_BEGIN: function(e2) {
  return Object.assign(e2, { "on:begin": (e3, n2) => {
    n2.data._beginMatch = e3[1];
  }, "on:end": (e3, n2) => {
    n2.data._beginMatch !== e3[1] && n2.ignoreMatch();
  } });
}, HASH_COMMENT_MODE: M, IDENT_RE: y, MATCH_NOTHING_RE: /\b\B/, METHOD_GUARD: $, NUMBER_MODE: I, NUMBER_RE: _, PHRASAL_WORDS_MODE: { begin: /\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/ }, QUOTE_STRING_MODE: v, REGEXP_MODE: B, RE_STARTERS_RE: "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", SHEBANG: (e2 = {}) => {
  const n2 = /^#![ ]*\//;
...
}, TITLE_MODE: L, UNDERSCORE_IDENT_RE: w, UNDERSCORE_TITLE_MODE: C });
function P(e2, n2) {
...
}, K = ["of", "and", "for", "in", "not", "or", "if", "then", "parent", "list", "value"], W = "keyword";
function X(e2, n2, t2 = W) {
...
const re = i, oe = s, ce = Symbol("nomatch"), le = function(e2) {
  ...
  function m2(e3, n2, t2) {
    ...
    v2("before:highlight", a3);
    const r3 = a3.result ? a3.result : E2(a3.language, a3.code, t2);
    return r3.code = a3.code, v2("after:highlight", r3), r3;
  }
  function E2(e3, n2, s3, a3) {
    ...
    function l2() {
      ...
      for (; n3; ) {
        ...
        const s4 = x3.case_insensitive ? n3[0].toLowerCase() : n3[0], a4 = (i3 = s4, v3.keywords[i3]);
        if (a4) {
          const [e5, i4] = a4;
      ...
      null != v3.subLanguage ? function() {
        ...
        if ("string" == typeof v3.subLanguage) {
          if (!i2[v3.subLanguage])
            return void k2.addText(R2);
          e4 = E2(v3.subLanguage, R2, true, O2[v3.subLanguage]), O2[v3.subLanguage] = e4._top;
        } else
          e4 = y2(R2, v3.subLanguage.length ? v3.subLanguage : null);
        v3.relevance > 0 && (M2 += e4.relevance), k2.__addSublanguage(e4._emitter, e4.language);
      }() : l2(), R2 = "";
    }
    function d2(e4, n3) {
    ...
    function f2(e4, n3) {
      return e4.scope && "string" == typeof e4.scope && k2.openNode(x3.classNameAliases[e4.scope] || e4.scope), e4.beginScope && (e4.beginScope._wrap ? (d2(R2, x3.classNameAliases[e4.beginScope._wrap] || e4.beginScope._wrap), R2 = "") : e4.beginScope._multi && (h2(e4.beginScope, n3), R2 = "")), v3 = Object.create(e4, { parent: { value: v3 } }), v3;
    }
    ...
    function p3(e4) {
      return 0 === v3.matcher.regexIndex ? (R2 += e4[0], 1) : (j2 = true, 0);
    }
    function m3(e4) {
      const t2 = e4[0], i3 = n2.substring(e4.index), s4 = b2(v3, e4, i3);
      if (!s4)
        return ce;
      const a4 = v3;
      v3.endScope && v3.endScope._wrap ? (g2(), d2(t2, v3.endScope._wrap)) : v3.endScope && v3.endScope._multi ? (g2(), h2(v3.endScope, e4)) : a4.skip ? R2 += t2 : (a4.returnEnd || a4.excludeEnd || (R2 += t2), g2(), a4.excludeEnd && (R2 = t2));
      do {
        v3.scope && k2.closeNode(), v3.skip || v3.subLanguage || (M2 += v3.relevance), v3 = v3.parent;
      } while (v3 !== s4.parent);
    ...
    function _3(i3, a4) {
      ...
      if (R2 += i3, null == o3)
        return g2(), 0;
      if ("begin" === w3.type && "end" === a4.type && w3.index === a4.index && "" === o3) {
      ...
      if ("illegal" === a4.type && !s3) {
        const e4 = new Error('Illegal lexeme "' + o3 + '" for mode "' + (v3.scope || "<unnamed>") + '"');
        throw e4.mode = v3, e4;
      }
      if ("end" === a4.type) {
        const e4 = m3(a4);
    ...
    const N3 = ie(x3);
    let S3 = "", v3 = a3 || N3;
    const O2 = {}, k2 = new u2.__emitter(u2);
    !function() {
      const e4 = [];
      for (let n3 = v3; n3 !== x3; n3 = n3.parent)
    ...
    try {
      if (x3.__emitTokens)
        ...
        for (v3.matcher.considerAll(); ; ) {
          T2++, j2 ? j2 = false : v3.matcher.considerAll(), v3.matcher.lastIndex = I2;
          const e4 = v3.matcher.exec(n2);
          if (!e4)
            break;
          const t2 = _3(n2.substring(I2, e4.index), e4);
          I2 = e4.index + t2;
        }
        _3(n2.substring(I2));
      }
      return k2.finalize(), S3 = k2.toHTML(), { language: e3, value: S3, relevance: M2, illegal: false, _emitter: k2, _top: v3 };
    } catch (t2) {
      if (t2.message && t2.message.includes("Illegal"))
        return { language: e3, value: re(n2), illegal: true, relevance: 0, _illegalBy: { message: t2.message, index: I2, context: n2.slice(I2 - 100, I2 + 100), mode: t2.mode, resultSoFar: S3 }, _emitter: k2 };
      if (r2)
        return { language: e3, value: re(n2), illegal: false, relevance: 0, errorRaised: t2, _emitter: k2, _top: v3 };
      throw t2;
    }
  }
  function y2(e3, n2) {
    ...
    }(e3), s3 = n2.filter(A2).filter(S2).map((n3) => E2(n3, e3, false));
    s3.unshift(t2);
  ...
  function w2(e3) {
    ...
    }(e3, t2, a3.language), e3.result = { language: a3.language, re: a3.relevance, relevance: a3.relevance }, a3.secondBest && (e3.secondBest = { language: a3.secondBest.language, relevance: a3.secondBest.relevance }), v2("after:highlightElement", { el: e3, result: a3, text: i3 });
  }
  let _2 = false;
  function x2() {
  ...
  "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", function() {
    _2 && x2();
  }, false), Object.assign(e2, { highlight: m2, highlightAuto: y2, highlightAll: x2, highlightElement: w2, highlightBlock: function(e3) {
  ...
  }, getLanguage: A2, registerAliases: N2, autoDetection: S2, inherit: oe, addPlugin: function(e3) {
    !function(e4) {
    ...
    r2 = true;
  }, e2.versionString = "11.9.0", e2.regex = { concat: f, lookahead: g, either: b, optional: h, anyNumberOfTimes: d };
  for (const e3 in D)
    "object" == typeof D[e3] && n(D[e3]);
  return Object.assign(e2, D), e2;
}, ue = le({});
ue.newInstance = () => le({});
var ge = ue;
ue.HighlightJS = ue, ue.default = ue;
const de = e(ge), he = "[A-Za-z$_][0-9A-Za-z$_]*", fe = ["as", "in", "of", "if", "for", "while", "finally", "var", "new", "function", "do", "return", "void", "else", "break", "catch", "instanceof", "with", "throw", "case", "default", "try", "switch", "continue", "typeof", "delete", "let", "yield", "const", "class", "debugger", "async", "await", "static", "import", "from", "export", "extends"], be = ["true", "false", "null", "undefined", "NaN", "Infinity"], pe = ["Object", "Function", "Boolean", "Symbol", "Math", "Date", "Number", "BigInt", "String", "RegExp", "Array", "Float32Array", "Float64Array", "Int8Array", "Uint8Array", "Uint8ClampedArray", "Int16Array", "Int32Array", "Uint16Array", "Uint32Array", "BigInt64Array", "BigUint64Array", "Set", "Map", "WeakSet", "WeakMap", "ArrayBuffer", "SharedArrayBuffer", "Atomics", "DataView", "JSON", "Promise", "Generator", "GeneratorFunction", "AsyncFunction", "Reflect", "Proxy", "Intl", "WebAssembly"], me = ["Error", "EvalError", "InternalError", "RangeError", "ReferenceError", "SyntaxError", "TypeError", "URIError"], Ee = ["setInterval", "setTimeout", "clearInterval", "clearTimeout", "require", "exports", "eval", "isFinite", "isNaN", "parseFloat", "parseInt", "decodeURI", "decodeURIComponent", "encodeURI", "encodeURIComponent", "escape", "unescape"], ye = ["arguments", "this", "super", "console", "window", "document", "localStorage", "sessionStorage", "module", "global"], we = [].concat(Ee, pe, me);
function _e(e2) {
  const n2 = e2.regex, t2 = he, i2 = "<>", s2 = "</>", a2 = { begin: /<[A-Za-z0-9\\._:-]+/, end: /\/[A-Za-z0-9\\._:-]+>|\/>/, isTrulyOpeningTag: (e3, n3) => {
    const t3 = e3[0].length + e3.index, i3 = e3.input[t3];
    if ("<" === i3 || "," === i3)
    ...
    const a3 = e3.input.substring(t3);
    ((s3 = a3.match(/^\s*=/)) || (s3 = a3.match(/^\s+extends\s+/)) && 0 === s3.index) && n3.ignoreMatch();
  } }, r2 = { $pattern: he, keyword: fe, literal: be, built_in: we, "variable.language": ye }, o2 = "[0-9](_?[0-9])*", c2 = `\\.(${o2})`, l2 = "0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*", u2 = { className: "number", variants: [{ begin: `(\\b(${l2})((${c2})|\\.)?|(${c2}))[eE][+-]?(${o2})\\b` }, { begin: `\\b(${l2})\\b((${c2})\\b|\\.)?|(${c2})\\b` }, { begin: "\\b(0|[1-9](_?[0-9])*)n\\b" }, { begin: "\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b" }, { begin: "\\b0[bB][0-1](_?[0-1])*n?\\b" }, { begin: "\\b0[oO][0-7](_?[0-7])*n?\\b" }, { begin: "\\b0[0-7]+n?\\b" }], relevance: 0 }, g2 = { className: "subst", begin: "\\$\\{", end: "\\}", keywords: r2, contains: [] }, d2 = { begin: "html`", end: "", starts: { end: "`", returnEnd: false, contains: [e2.BACKSLASH_ESCAPE, g2], subLanguage: "xml" } }, h2 = { begin: "css`", end: "", starts: { end: "`", returnEnd: false, contains: [e2.BACKSLASH_ESCAPE, g2], subLanguage: "css" } }, f2 = { begin: "gql`", end: "", starts: { end: "`", returnEnd: false, contains: [e2.BACKSLASH_ESCAPE, g2], subLanguage: "graphql" } }, b2 = { className: "string", begin: "`", end: "`", contains: [e2.BACKSLASH_ESCAPE, g2] }, p2 = { className: "comment", variants: [e2.COMMENT(/\/\*\*(?!\/)/, "\\*/", { relevance: 0, contains: [{ begin: "(?=@[A-Za-z]+)", relevance: 0, contains: [{ className: "doctag", begin: "@[A-Za-z]+" }, { className: "type", begin: "\\{", end: "\\}", excludeEnd: true, excludeBegin: true, relevance: 0 }, { className: "variable", begin: t2 + "(?=\\s*(-)|$)", endsParent: true, relevance: 0 }, { begin: /(?=[^\n])\s/, relevance: 0 }] }] }), e2.C_BLOCK_COMMENT_MODE, e2.C_LINE_COMMENT_MODE] }, m2 = [e2.APOS_STRING_MODE, e2.QUOTE_STRING_MODE, d2, h2, f2, b2, { match: /\$\d+/ }, u2];
  g2.contains = m2.concat({ begin: /\{/, end: /\}/, keywords: r2, contains: ["self"].concat(m2) });
  const E2 = [].concat(p2, g2.contains), y2 = E2.concat([{ begin: /\(/, end: /\)/, keywords: r2, contains: ["self"].concat(E2) }]), w2 = { className: "params", begin: /\(/, end: /\)/, excludeBegin: true, excludeEnd: true, keywords: r2, contains: y2 }, _2 = { variants: [{ match: [/class/, /\s+/, t2, /\s+/, /extends/, /\s+/, n2.concat(t2, "(", n2.concat(/\./, t2), ")*")], scope: { 1: "keyword", 3: "title.class", 5: "keyword", 7: "title.class.inherited" } }, { match: [/class/, /\s+/, t2], scope: { 1: "keyword", 3: "title.class" } }] }, x2 = { relevance: 0, match: n2.either(/\bJSON/, /\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/, /\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/, /\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/), className: "title.class", keywords: { _: [...pe, ...me] } }, A2 = { variants: [{ match: [/function/, /\s+/, t2, /(?=\s*\()/] }, { match: [/function/, /\s*(?=\()/] }], className: { 1: "keyword", 3: "title.function" }, label: "func.def", contains: [w2], illegal: /%/ };
  const N2 = { match: n2.concat(/\b/, (S2 = [...Ee, "super", "import"], n2.concat("(?!", S2.join("|"), ")")), t2, n2.lookahead(/\(/)), className: "title.function", relevance: 0 };
  var S2;
  const v2 = { begin: n2.concat(/\./, n2.lookahead(n2.concat(t2, /(?![0-9A-Za-z$_(])/))), end: t2, excludeBegin: true, keywords: "prototype", className: "property", relevance: 0 }, O2 = { match: [/get|set/, /\s+/, t2, /(?=\()/], className: { 1: "keyword", 3: "title.function" }, contains: [{ begin: /\(\)/ }, w2] }, k2 = "(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|" + e2.UNDERSCORE_IDENT_RE + ")\\s*=>", R2 = { match: [/const|var|let/, /\s+/, t2, /\s*/, /=\s*/, /(async\s*)?/, n2.lookahead(k2)], keywords: "async", className: { 1: "keyword", 3: "title.function" }, contains: [w2] };
  return { name: "JavaScript", aliases: ["js", "jsx", "mjs", "cjs"], keywords: r2, exports: { PARAMS_CONTAINS: y2, CLASS_REFERENCE: x2 }, illegal: /#(?![$_A-z])/, contains: [e2.SHEBANG({ label: "shebang", binary: "node", relevance: 5 }), { label: "use_strict", className: "meta", relevance: 10, begin: /^\s*['"]use (strict|asm)['"]/ }, e2.APOS_STRING_MODE, e2.QUOTE_STRING_MODE, d2, h2, f2, b2, p2, { match: /\$\d+/ }, u2, x2, { className: "attr", begin: t2 + n2.lookahead(":"), relevance: 0 }, R2, { begin: "(" + e2.RE_STARTERS_RE + "|\\b(case|return|throw)\\b)\\s*", keywords: "return throw case", relevance: 0, contains: [p2, e2.REGEXP_MODE, { className: "function", begin: k2, returnBegin: true, end: "\\s*=>", contains: [{ className: "params", variants: [{ begin: e2.UNDERSCORE_IDENT_RE, relevance: 0 }, { className: null, begin: /\(\s*\)/, skip: true }, { begin: /\(/, end: /\)/, excludeBegin: true, excludeEnd: true, keywords: r2, contains: y2 }] }] }, { begin: /,/, relevance: 0 }, { match: /\s+/, relevance: 0 }, { variants: [{ begin: i2, end: s2 }, { match: /<[A-Za-z0-9\\._:-]+\s*\/>/ }, { begin: a2.begin, "on:begin": a2.isTrulyOpeningTag, end: a2.end }], subLanguage: "xml", contains: [{ begin: a2.begin, end: a2.end, skip: true, contains: ["self"] }] }] }, A2, { beginKeywords: "while if switch catch for" }, { begin: "\\b(?!function)" + e2.UNDERSCORE_IDENT_RE + "\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{", returnBegin: true, label: "func.def", contains: [w2, e2.inherit(e2.TITLE_MODE, { begin: t2, className: "title.function" })] }, { match: /\.\.\./, relevance: 0 }, v2, { match: "\\$" + t2, relevance: 0 }, { match: [/\bconstructor(?=\s*\()/], className: { 1: "title.function" }, contains: [w2] }, N2, { relevance: 0, match: /\b[A-Z][A-Z_0-9]+\b/, className: "variable.constant" }, _2, O2, { match: /\$[(.]/ }] };
}
function xe(e2 = document) {
  e2.querySelectorAll('code[lang="typescript"],code[lang="ts"]').forEach((e3) => {
    de.highlightElement(e3);
  });
}
de.registerLanguage("typescript", (e2) => function(e3) {
  const n2 = _e(e3), t2 = he, i2 = ["any", "void", "number", "boolean", "string", "object", "never", "symbol", "bigint", "unknown"], s2 = { beginKeywords: "namespace", end: /\{/, excludeEnd: true, contains: [n2.exports.CLASS_REFERENCE] }, a2 = { beginKeywords: "interface", end: /\{/, excludeEnd: true, keywords: { keyword: "interface extends", built_in: i2 }, contains: [n2.exports.CLASS_REFERENCE] }, r2 = { $pattern: he, keyword: fe.concat(["type", "namespace", "interface", "public", "private", "protected", "implements", "declare", "abstract", "readonly", "enum", "override"]), literal: be, built_in: we.concat(i2), "variable.language": ye }, o2 = { className: "meta", begin: "@" + t2 }, c2 = (e4, n3, t3) => {
    const i3 = e4.contains.findIndex((e5) => e5.label === n3);
    if (-1 === i3)
      throw new Error("can not find mode to replace");
    e4.contains.splice(i3, 1, t3);
  };
  return Object.assign(n2.keywords, r2), n2.exports.PARAMS_CONTAINS.push(o2), n2.contains = n2.contains.concat([o2, s2, a2]), c2(n2, "shebang", e3.SHEBANG()), c2(n2, "use_strict", { className: "meta", relevance: 10, begin: /^\s*['"]use strict['"]/ }), n2.contains.find((e4) => "func.def" === e4.label).relevance = 0, Object.assign(n2, { name: "TypeScript", aliases: ["ts", "tsx", "mts", "cts"] }), n2;
}(e2)), void 0 === window.process && xe(document);
export {
  xe as execHighlight
};
